...
static unsigned int
c6x_function_arg_boundary (machine_mode mode, const_tree type, bool named)
{
...
static unsigned int
c6x_function_arg_round_boundary (machine_mode mode, const_tree type, bool named)
{
  return c6x_function_arg_boundary (mode, type, named);
}
